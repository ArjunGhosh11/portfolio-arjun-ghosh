        ...
        <div class="navbar bg-accent text-neutral ">
            ...
            <div class="navbar-center hidden lg:flex">
                <ul class="menu menu-horizontal p-0">
                    <li><a><p className='font-bold'>HOME</p></a></li>
                    <li><a><p className='font-bold'>MY PROJECTS</p></a></li>
                    <li><a><p className='font-bold'>GET IN TOUCH</p></a></li>
                    <li><a><p className='font-bold'>BLOGS</p></a></li>
                </ul>
            </div>
